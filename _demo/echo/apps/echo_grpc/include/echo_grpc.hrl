...
-define(echo_grpc_header_prefix, "x-echo-").
-define(echo_grpc_header_agent_id, <<?echo_grpc_header_prefix, "agent-id">>).
-define(echo_grpc_header_agent_instance, <<?echo_grpc_header_prefix, "agent-instance">>).
-define(echo_grpc_header_request_id, <<?echo_grpc_header_prefix, "request-id">>).
