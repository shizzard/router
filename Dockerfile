...
ENV ROUTER_APP_HASHRING_BUCKETS_PO2=10
ENV ROUTER_APP_HASHRING_NODES_PO2=6

ENV ROUTER_APP_GRPC_LISTENER_PORT=8137

ENV ROUTER_APP_GRPC_SESSION_INACTIVITY_LIMIT_MS=15000
